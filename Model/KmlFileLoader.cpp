...
void KmlFileLoader::updateMinMaxLatLon(double longitude, double latitude, 
...
QPolygonF KmlFileLoader::parseCoordinateString(const QString& coordsString, 
                                               double& minLon, double& maxLon, 
                                               double& minLat, double& maxLat) {
    QPolygonF result;
...
QList<QPolygonF> KmlFileLoader::parseCoordinatesFromDocument(QDomDocument* document, 
                                                            double& minLon, double& maxLon, 
                                                            double& minLat, double& maxLat) {
    if (!document) {
