...
void PolyRepr::addPolygon(const PolygonTriple& triple) { polygons.append(triple); }
...
int PolyRepr::size() const { return polygons.size(); }

bool PolyRepr::empty() const { return polygons.isEmpty(); }

void PolyRepr::clear() { polygons.clear(); }

// Iterator access
PolyRepr::iterator PolyRepr::begin() { return polygons.begin(); }

PolyRepr::iterator PolyRepr::end() { return polygons.end(); }

PolyRepr::const_iterator PolyRepr::begin() const { return polygons.begin(); }

PolyRepr::const_iterator PolyRepr::end() const { return polygons.end(); }

PolyRepr::const_iterator PolyRepr::cbegin() const { return polygons.cbegin(); }

PolyRepr::const_iterator PolyRepr::cend() const { return polygons.cend(); }
